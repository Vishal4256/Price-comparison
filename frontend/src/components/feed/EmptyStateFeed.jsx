        ...
        <div className="max-w-7xl mx-auto px-4 py-8 space-y-12">
            ...
            <div className="text-center py-16 bg-gradient-to-b from-indigo-50 to-white rounded-3xl border border-indigo-100">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <button className="flex items-center justify-center gap-2 px-6 py-3 bg-[#0B1E36] text-white rounded-xl hover:bg-[#1a365d] transition-colors font-medium">
                        <Search className="w-5 h-5" /> Start Searching
                    </button>
                    <button className="flex items-center justify-center gap-2 px-6 py-3 bg-white text-rose-500 border border-rose-200 rounded-xl hover:bg-rose-50 transition-colors font-medium">
